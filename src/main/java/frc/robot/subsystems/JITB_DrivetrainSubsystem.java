...
public class JITB_DrivetrainSubsystem extends SwerveDrivetrain {
    ...
    private static final JITB_DrivetrainSubsystem instance = new JITB_DrivetrainSubsystem();
    ...
    private JITB_DrivetrainSubsystem() {
    ...
    public static JITB_DrivetrainSubsystem getInstance() {
        return instance;
    }
